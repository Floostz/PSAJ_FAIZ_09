...
function Subtraction() {
  ...
  function leaveGameConfirmation(){
      const leaveGame = confirm("Apakah Anda yakin ingin keluar dari permainan?")
    ...
    <main className="gameplay-main">
      ...
      <div 
        ...
        className="score-showcase">
          <p>Ups, jawaban itu tidak benar, {`${randomNumber} ${sign} ${randomNumber2}`} sebenarnya adalah<span> {correctAnswer}</span></p>
