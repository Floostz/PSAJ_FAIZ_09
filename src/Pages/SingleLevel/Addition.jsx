  ...
  function handleButtonClick() {
    if (currentQuestion == 5) {
      if (activeButton == correctAnswer) {
        ...
        highScoreSetter(score + 20, "penjumlahan")
        navigate("/score")
      } else {
        playSoundEffect(audioWrongRef)
        setGlobalScore(score)
        highScoreSetter(score, "penjumlahan")
    ...
    <main className="gameplay-main">
      ...
      <div
        ...
        <div className="score-showcase">
          <p>Oops, jawabanmu salah. {`${randomNumber} ${sign} ${randomNumber2}`} seharusnya adalah<span> {correctAnswer}</span></p>
